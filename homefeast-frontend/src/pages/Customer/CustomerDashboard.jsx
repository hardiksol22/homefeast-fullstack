          ...
          <div className="p-6 flex flex-col flex-1 justify-between">
            <div>
              ...
              <div className="flex gap-2">
                <div className="h-6 w-20 bg-[#1E293B] rounded-md"></div>
                <div className="h-6 w-24 bg-[#1E293B] rounded-md"></div>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-[#080D12] text-[#F8FAFC] pt-36 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* 🎛️ Super Advanced Sticky Search & Filter Bar */}
        ...
        {error && (
          <div className="w-full text-center py-20 bg-rose-500/5 border border-rose-500/20 rounded-3xl max-w-4xl mx-auto shadow-2xl relative overflow-hidden">
            ...
            <p className="text-[#94A3B8] text-lg max-w-xl mx-auto">{error}</p>
            <p className="text-sm text-[#64748B] mt-6 bg-[#080D12] inline-block px-4 py-2 rounded-full border border-[#263241]">
              💡 Note: Free Render servers spin down after inactivity. Give it 30-50 seconds and refresh.
            </p>
            <button onClick={() => window.location.reload()} className="mt-8 px-8 py-3.5 bg-[#111827] border border-[#263241] text-[#F8FAFC] font-black rounded-xl hover:bg-[#1E293B] hover:text-[#10B981] hover:border-[#10B981] transition-all shadow-lg">
              Refresh Page Now
            </button>
          </div>
        )}
          ...
          <>
            {filteredProviders.length > 0 ? (
                  ...
                  <div key={provider._id} className="bg-[#111827] border border-[#263241] rounded-3xl overflow-hidden group flex flex-col hover:border-[#10B981]/50 hover:shadow-[0_15px_50px_rgba(16,185,129,0.15)] transition-all duration-500 transform hover:-translate-y-2 relative">
                    ...
                    <div className="p-7 relative -mt-6 flex flex-col flex-1 bg-[#111827] rounded-t-[32px] border-t border-[#263241]/50 z-10">
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <h3 className="text-2xl font-black text-[#F8FAFC] line-clamp-1 group-hover:text-[#10B981] transition-colors">{provider.kitchenName}</h3>
                      </div>
                      
                      <p className="text-[#94A3B8] text-sm mb-5 font-semibold flex items-center gap-1.5">
                      ...
                      <div className="mt-auto pt-2">
                        <Link 
                          ...
                          className="w-full flex items-center justify-center gap-3 px-4 py-4 bg-[#080D12] text-[#F8FAFC] text-sm font-black rounded-2xl border border-[#263241] group-hover:bg-[#10B981] group-hover:text-[#080D12] group-hover:border-[#10B981] transition-all duration-300 shadow-md relative overflow-hidden"
                        >
                          <span className="relative z-10 flex items-center gap-2">
                            Explore Kitchen Menu
                            <svg className="w-4 h-4 opacity-50 group-hover:opacity-100 transition-all transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                          </span>
                        </Link>
                      </div>
                    </div>
              ...
              <div className="w-full text-center py-24 bg-[#111827] border border-[#263241] rounded-3xl mt-4 shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative overflow-hidden">
                ...
                <div className="w-24 h-24 bg-[#080D12] rounded-full flex items-center justify-center mx-auto mb-6 border-2 border-[#263241] shadow-inner relative z-10">
                  <span className="text-5xl opacity-80">🍽️</span>
                </div>
                
                <h3 className="text-3xl font-black text-[#F8FAFC] relative z-10">No Kitchens Found</h3>
                
                {searchTerm || cuisineFilter !== "All" ? (
                  <div className="relative z-10">
                    <p className="text-[#94A3B8] mt-4 text-lg max-w-md mx-auto">
                      We couldn't find any kitchens matching your current filters. 
                    </p>
                    <button 
                      onClick={() => {setSearchTerm(""); setCuisineFilter("All");}} 
                      className="mt-8 px-8 py-3.5 bg-[#10B981]/10 text-[#10B981] border border-[#10B981]/30 font-bold rounded-xl hover:bg-[#10B981] hover:text-[#080D12] transition-colors"
                    >
                      Clear All Filters
                    </button>
                  </div>
                ) : (
                  <p className="text-[#94A3B8] mt-4 text-lg mb-8 max-w-xl mx-auto relative z-10 leading-relaxed">
                    We are currently expanding our services in your area. New authentic home kitchens and passionate chefs will be added here very soon. Stay tuned for a feast!
                  </p>
                )}
              </div>
            )}
